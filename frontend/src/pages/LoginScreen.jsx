                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full bg-gray-50 border border-gray-300 rounded-lg pl-4 pr-12 py-3 text-base text-gray-800 focus:outline-none focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20 transition-all placeholder:text-gray-400"
                                    placeholder="••••••"
                                    value={password}
