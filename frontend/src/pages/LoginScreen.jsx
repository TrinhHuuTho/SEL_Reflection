        ...
        <div className="min-h-screen flex items-center justify-center relative bg-brand-bg overflow-hidden py-4">
            ...
            <div className="relative z-10 w-full max-w-sm px-4">
                <div className="bg-white rounded-3xl shadow-2xl p-6 border-4 border-brand-secondary transform hover:scale-[1.01] transition-transform duration-300">
                    ...
                    <h2 className="text-2xl font-black text-center text-brand-primary mt-10 mb-1">
                        CỔNG KHÁM PHÁ
                    </h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        {/* Password Input */}
                        <div>
                            <label className="block text-brand-text font-bold mb-1 ml-2 text-sm">Mật khẩu bí mật</label>
                            <input
                                type="password"
                                className="w-full bg-blue-50 border-2 border-blue-200 rounded-xl px-4 py-3 text-base font-bold text-brand-text focus:outline-none focus:border-brand-primary focus:ring-4 focus:ring-brand-primary/20 transition-all placeholder:text-blue-200"
                                placeholder="******"
                        ...
                        {/* Error Message */}
                        {error && (
                            <div className="bg-red-100 text-red-500 p-2 rounded-xl text-center font-bold animate-pulse text-sm">
                                ⚠️ {error}
                            </div>
                        )}
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-brand-primary hover:bg-red-400 text-white text-lg font-black py-3 rounded-xl shadow-[0_4px_0_rgb(200,50,50)] active:shadow-none active:translate-y-[4px] transition-all disabled:opacity-70 disabled:cursor-not-allowed group relative overflow-hidden"
                        >
                            {isLoading ? (
                        ...
                        <div className="relative flex py-1 items-center">
                            ...
                            <span className="flex-shrink-0 mx-4 text-gray-400 font-medium text-xs">HOẶC</span>
                            <div className="flex-grow border-t border-gray-200"></div>
                        </div>
                        ...
                        <button
                            ...
                            disabled={isLoading}
                            className="w-full bg-white hover:bg-gray-50 text-gray-700 border-2 border-gray-200 text-base font-bold py-2.5 rounded-xl shadow-sm hover:shadow-md transition-all flex items-center justify-center gap-2 active:scale-95 disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                            {/* Google Icon SVG */}
